...
import { getAutoDeleteMessageFactory } from "./apis/getAutoDeleteMessage.js";
...
export class API {
    ...
    public getAutoDeleteMessage: ReturnType<typeof getAutoDeleteMessageFactory>;
    ...
    constructor(ctx: ContextSession, zpwServiceMap: ZPWServiceMap, wsUrls: string[]) {
        ...
        this.getAutoDeleteMessage = getAutoDeleteMessageFactory(ctx, this);
