...
export class API {
    ...
    constructor(zpwServiceMap: Record<string, string[]>, wsUrl: string) {
        ...
        this.changeNickName = changeNickNameFactory(this);
